...
% from the time-lapse movie dataset that is used for Exercises 5, 6.    %
% The equally sized extracted patches from all used frames of the       %
...
% for the needs of Exercises 5, 6. Finally, the extracted subimages are %
% converted from unint8 to double with intensity in the range [0, 1].   %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
