...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This script pertains to the implementation of task D, where PCA is    %
% used for weights and biases initialization of a 3-hidden layer deep   %
% neural network. If the neurons in the 2nd hidden layer are three,     %
% then a 3-D plot of their response across the whole test dataset is    %
% obtained, as requested in task E.                                     %
%                                                                       %
%                                                                       %
...
% activation function: either 'logsig' or 'tansig'(task G).             %
%                                                                       %
%                                                                       %
% IMPORTANT !!!                                                         %
% Here, s = 1/40 (line 55).                                             %
...
%% Task E - 3D Plot neurons response in the 2nd hidden layer (only with 3 neurons)
