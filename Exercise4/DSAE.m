...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This script pertains to the implementation of task D, where           %
% denoising stacked autoencoders are used for weights and biases        %
% initialization of a 3-hidden layer deep  neural network.              %
...
images_noise = images;
images_noise = pepperNoise(images_noise, 0.1);
autoenc1 = trainAutoencoder(images_noise, hiddenSize(1), ...     
                            'MaxEpochs', 1500, ...
...
features1 = encode(autoenc1, images_noise);
